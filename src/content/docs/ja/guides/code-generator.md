...
:::note
古いコードジェネレーターは3.5.0以下のバージョンに適用されます。3.5.1以上のバージョンを使用している場合は、[新コードジェネレーター](/guides/new-code-generator/)を参照して設定・使用してください。新しいコードジェネレーターはよりシンプルかつ強力で、すべてのユーザーに新しいコードジェネレーターへのアップグレードを推奨します。
:::
...
より詳細な設定については、[コードジェネレーター設定](/reference/code-generator-configuration)を参照してください。
...
より詳細なジェネレーター設定については、[コードジェネレーター設定](/reference/code-generator-configuration/)を参照してください。
